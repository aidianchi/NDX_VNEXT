    ...
    "metrics": {
        "get_ndx_pe_and_earnings_yield": {
            ...
            "value": {
                ...
                "PE_TTM_percentile_10y": None,
                "ForwardPE_percentile_5y": None,
                "ForwardPE_percentile_10y": None,
                "FCFYield_percentile_5y": None,
                "PB_percentile_5y": None,
                "PB_percentile_10y": None,
                "PS_TTM_percentile_5y": None,
                "PS_TTM_percentile_10y": None,
            },
            "unit": "ratio/percent",
        ...
        "get_damodaran_us_implied_erp": {
            ...
            "value": {
                ...
                "manual_erp_percentile_10y": None,
        ...
        "get_qqq_top10_concentration": {
            ...
            "value": {
                ...
                "m7_weight_pct": None,
                "top10_holdings": [],
                "market_cap_vs_equal_weight": {},
            },
            "unit": "percent",
            "source_tier": "licensed_manual/Wind",
            "source_name": "Manual Input (optional holdings source)",
            "data_quality": {
                "source_tier": "licensed_manual/Wind",
                "data_date": "",
                "collected_at_utc": "",
                "update_frequency": "user supplied",
                "formula": "User-supplied Top10 holdings concentration and QQQ/equal-weight spread.",
                "coverage": {"note": "Manual holdings source coverage must be supplied or reviewed by user."},
                "anomalies": [],
                "fallback_chain": ["licensed_manual/Wind", "official_provider/Invesco", "proxy/yfinance", "unavailable"],
                "source_disagreement": {},
            },
            "notes": "Optional manual holdings/concentration input.",
        },
        "get_ndx_forward_earnings_quality": {
            ...
            "value": {
                "ndx": {
                    ...
                    "forward_earnings_yield_pct": None,
                    "forward_eps_growth_proxy_pct": None,
                    "weighted_profit_margin_pct": None,
                    "weighted_operating_margin_pct": None,
                },
                "m7": {
                    "eps_revisions": {
                        "weighted_next_year_eps_revision_30d_pct": None,
                        "revision_direction_30d": None,
                    }
                },
            },
            ...
            "data_quality": {
                ...
                "collected_at_utc": "",
                "update_frequency": "user supplied",
                "formula": "Optional forward EPS, analyst revision and margin-quality fields.",
                "coverage": {"note": "Manual source coverage must be supplied or reviewed by user."},
                "anomalies": [],
                "fallback_chain": ["licensed_manual/Wind", "component_model", "proxy", "unavailable"],
                "source_disagreement": {},
            },
            "notes": "Optional high-trust forward earnings and revision input.",
        },
