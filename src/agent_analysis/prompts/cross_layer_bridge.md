...
| C | 估值昂贵 vs 趋势强劲 | 是否触发？ |
| D | 宏观悲观 vs 护城河削弱 | 是否触发？ |
| E | 内部健康度强 vs 仓位拥挤 | 是否触发？ |
| F | 估值合理 vs 趋势向下 | 是否触发？ |
| G | 估值昂贵 vs 趋势向下 | 是否触发？ |
| H | 趋势强势 vs 信用利差扩大 | 是否触发？ |
| I | 指数强势 vs XLY/XLP 下降 | 是否触发？ |
| J | 10Y 收益率上升 vs 铜金比下降 | 是否触发？ |
| K | 指数创新高 vs A/D 线恶化 | 是否触发？ |
| L | 基本面/健康度强 vs 情绪拥挤 | 是否触发？ |
| M | 宏观/情绪乐观 vs 技术背离 | 是否触发？ |
