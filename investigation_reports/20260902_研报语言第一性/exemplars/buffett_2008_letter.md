---
title: "Berkshire Hathaway Inc. 2008 Annual Report — Chairman's Letter"
author: Warren E. Buffett
date: 2009-02-27
source_url: https://www.berkshirehathaway.com/letters/2008ltr.pdf
retrieved: 2026-09-06
retrieval_method: "curl 下载官网 PDF（22 页），pdftotext -layout 提取后清洗为 markdown；表格保留为等宽文本块"
exemplar_for: 语域基准范本签字页 —— 代表段落见 09_范本签字页.md
---

# Berkshire Hathaway 2008 年致股东信（英文原文全文）

> 以下为巴菲特 2008 年致股东信全文（签署日期 2009-02-27），来源为伯克希尔官网一手 PDF。
> 排版说明：正文段落已合并换行；原文中的表格以等宽文本块（```text）原样保留，数字未做任何改动。
