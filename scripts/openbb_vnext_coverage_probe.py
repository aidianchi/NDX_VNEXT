...
def _coverage_candidates() -> List[Candidate]:
    return [
        ...
        Candidate(3, "get_qqq_qqew_ratio", "yfinance QQQ/QQEW", "Cap-weight vs equal-weight leadership", "Daily price can be date-filtered; formula local.", "obb.equity.price.historical('QQQ','QQEW')", "yfinance", "candidate_partial", "good_for_observation_date", "OpenBB can supply legs; vNext keeps ratio semantics.", _equity_price("QQEW", "yfinance")),
